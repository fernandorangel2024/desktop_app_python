...
lb_x.config(bg="white", fg="black", font=("Helvetica", 18))
lb_x.place(x=240, y=60)

# caja de texto para x
entry_x = Entry(frame_entrada, textvariable=x)
entry_x.config(bg="white", fg="black", font=("Times New Roman", 18), width=6)
entry_x.focus_set()
...
entry_y.config(bg="white", fg="black", font=("Times New Roman", 18), width=6)
...
t_resultados.config(bg="white", fg="black", font=("Courtier", 18))
